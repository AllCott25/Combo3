...
let intermediate_combinations = [
  ...
  function loadWallpaperSVGHighRes() {
    ...
    }, 5000); // Reduced to 5 seconds for faster fallback - APlasker
    ...
    img.onload = function() {
      ...
      // Create high-resolution canvas (1.5x natural size for faster loading) - APlasker
      const hiResScale = 1.5; // Reduced from 2x to 1.5x for faster loading - APlasker
